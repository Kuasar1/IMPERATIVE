...
import mn.ezbuy.customerservice.entity.Role;
import mn.ezbuy.customerservice.repository.CustomerRepository;
import mn.ezbuy.customerservice.repository.RoleRepository;
import mn.ezbuy.customerservice.utils.Status;
	...
	public ResponseEntity<String> fullOnboard(Customer customer) {
		try {
			...
			if (!exists) {
				...
				Customer existingUser = customerRepository.getById(customer.getId());
